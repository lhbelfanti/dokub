...
kubectl set image deployments/client-deployment client=lhbelfanti/multi-client:$SHA
kubectl set image deployments/server-deployment server=lhbelfanti/multi-server:$SHA
kubectl set image deployments/worker-deployment worker=lhbelfanti/multi-worker:$SHA